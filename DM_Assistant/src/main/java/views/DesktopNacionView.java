...
public class DesktopNacionView {
    ...
    private static final Rectangle2D VISTA_DORNAN = new Rectangle2D(976, 330, 600, 375);
    ...
    private static final Rectangle2D VISTA_PATRIA = new Rectangle2D(858, 948, 500, 312);
    ...
    private Rectangle2D getVistaParaNacion(String nombre) {
        switch (nombre) {
            ...
            case "Archipiélago Coralino": return VISTA_ARCHIPIELAGO;
            ...
            case "Patria Nagi": return VISTA_PATRIA;
