	...
	public void crearVentana() {
        ...
        switch (type) {
            case PERSONAJE:
            	...
            	CreationPersonajeController controlPj = new CreationPersonajeController(this, viewPj, explorerController, mundo, npcPj);
                contenidoConPadding.getChildren().add(viewPj);
                break;
            case NPC:
            	boolean npcNpc = true;
            	CreationPersonajeView viewNpc = new CreationPersonajeView();
            	CreationPersonajeController controlNpc = new CreationPersonajeController(this, viewNpc, explorerController, mundo, npcNpc);
                contenidoConPadding.getChildren().add(viewNpc);
                break;
            case CRIATURA:
            	CreationCriaturaView viewCriatura = new CreationCriaturaView();
            	CreationCriaturaController controlCriatura = new CreationCriaturaController(this, viewCriatura, explorerController, mundo);
                contenidoConPadding.getChildren().add(viewCriatura);
                break;
            case UBICACION:
            	CreationUbicacionView viewUbicacion = new CreationUbicacionView(mundo);
            	CreationUbicacionController controlUbicacion = new CreationUbicacionController(this, viewUbicacion, explorerController, mundo, item);
