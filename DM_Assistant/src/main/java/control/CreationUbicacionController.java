...
public class CreationUbicacionController {
    ...
    private void inicializarEventos() {
        view.getCrearButton().setOnAction(e -> crearUbicacion());
    ...
    private void crearUbicacion() {
        ...
        Ubicacion nuevaUbicacion = new Ubicacion(reino, nombre, tipo);
        reino.addUbicacion(nuevaUbicacion);	
        boolean exito = ubicacionCRUD.saveUbicacion(nuevaUbicacion);

        if (exito) {
            reino.getUbicaciones().add(nuevaUbicacion); // Si manejas la relación en memoria
