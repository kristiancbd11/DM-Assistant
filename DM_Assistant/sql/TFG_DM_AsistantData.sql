...
VALUES ('Ojos de medianoche', 'No sufrir�s ceguera por oscuridad o brumas', 0);
INSERT INTO RASGOS (idHabilidad, unlockLvl)
VALUES ((SELECT idHabilidad FROM HABILIDADES WHERE nombre = 'Ojos de medianoche'), 1);

INSERT INTO HABILIDADES (nombre, descripcion, activa) 
VALUES ('Cultura medicinal', 'Todas los desaf�os de Medicina que realices tendr�n un bonificador de +1d6 adicional. Adem�s siempre que cures a un objetivo o a ti mismo curar�s +1d8 extra.', 0);
INSERT INTO RASGOS (idHabilidad, unlockLvl)
VALUES ((SELECT idHabilidad FROM HABILIDADES WHERE nombre = 'Cultura medicinal'), 1);

INSERT INTO HABILIDADES (nombre, descripcion, activa) 
VALUES ('Acero y roca', 'Obtienes 1d4 de impacto y combate con cualquier martillo que empu�es. Adem�s, todos los hechizos de elemento monta�oso que conjures aplicar�n 1d4 de da�o adicional por cada dado de impacto que emplee el hechizo.', 0);
INSERT INTO RASGOS (idHabilidad, unlockLvl)
VALUES ((SELECT idHabilidad FROM HABILIDADES WHERE nombre = 'Acero y roca'), 1);

INSERT INTO HABILIDADES (nombre, descripcion, activa) 
VALUES ('Fortaleza mental', 'Obtienes +1d4 a todos tus desaf�os de Inteligencia. Siempre que vayas a recibir un penalizador a la Inteligencia podr�s realizar un desaf�o de Intuici�n (15) para evitar recibirlo.', 0);
INSERT INTO RASGOS (idHabilidad, unlockLvl)
VALUES ((SELECT idHabilidad FROM HABILIDADES WHERE nombre = 'Fortaleza mental'), 1);

INSERT INTO HABILIDADES (nombre, descripcion, activa) 
VALUES ('Camuflaje natural', 'Una vez por descanso largo podr�s volverte invisible durante 3 minutos', 1);
INSERT INTO RASGOS (idHabilidad, unlockLvl)
VALUES ((SELECT idHabilidad FROM HABILIDADES WHERE nombre = 'Camuflaje natural'), 1);

INSERT INTO HABILIDADES (nombre, descripcion, activa) 
VALUES ('Afortunado', 'Una vez por descanso largo podr�s erepetir cualquier tirada de dado que realices.', 1);
INSERT INTO RASGOS (idHabilidad, unlockLvl)
VALUES ((SELECT idHabilidad FROM HABILIDADES WHERE nombre = 'Afortunado'), 1);

INSERT INTO HABILIDADES (nombre, descripcion, activa) 
VALUES ('Vigor del norte', 'Podr�s realizar un desaf�o de Resistencia (15) para ignorar cualquier estado f�sico que te provoquen. Si falla no podr�s volver a intentar retirarlo con este m�todo hasta tu siguiente descanso largo.', 0);
INSERT INTO RASGOS (idHabilidad, unlockLvl)
VALUES ((SELECT idHabilidad FROM HABILIDADES WHERE nombre = 'Vigor del norte'), 1);

INSERT INTO HABILIDADES (nombre, descripcion, activa) 
VALUES ('Brutalidad', 'Podr�s aplicar hasta 3 bonificador de 1d6 a tus desaf�os de Fuerza o Constituci�n por cada descanso largo.', 1);
INSERT INTO RASGOS (idHabilidad, unlockLvl)
VALUES ((SELECT idHabilidad FROM HABILIDADES WHERE nombre = 'Brutalidad'), 1);

/*Rasgo de b�rbaro*/
INSERT INTO HABILIDADES (nombre, descripcion, activa) 
VALUES ('Furia de batalla', 'Cada vez que golpees a un objetivo obtendr�s 2 puntos de furia hasta un m�ximo de 10. Podr�s entrar en estado de furia para poder consumir tus puntos de furia y lanzar tus talentos de b�rbaro. Una vez termine el estado de furia se perder�n todos los puntos de furia. El estado de furia terminar� autom�ticamente si no intentas golpear a un objetivo en 3 turnos (1:30 min).', 0);
INSERT INTO RASGOS (idHabilidad, unlockLvl)
...
VALUES (01, 'B�rbaro', '1d8', 101, HEXTORAW('70'), HEXTORAW('4'));
INSERT INTO CLASES (idClase, nombre, dado, idArquetipo, armas, armaduras) 
VALUES (02, 'Bardo', '1d4', 102, HEXTORAW('40'), HEXTORAW('0'));
INSERT INTO CLASES (idClase, nombre, dado, idArquetipo, armas, armaduras) 
VALUES (03, 'Cl�rigo', '1d6', 103, HEXTORAW('64'), HEXTORAW('6'));
INSERT INTO CLASES (idClase, nombre, dado, idArquetipo, armas, armaduras) 
...
INSERT INTO CLASES (idClase, nombre, dado, idArquetipo, armas, armaduras) 
VALUES (07, 'Palad�n', '1d8', 107, HEXTORAW('74'), HEXTORAW('7'));
INSERT INTO CLASES (idClase, nombre, dado, idArquetipo, armas, armaduras) 
VALUES (08, 'P�caro', '1d6', 108, HEXTORAW('C8'), HEXTORAW('4'));
...
INSERT INTO SUBCLASES (idSubclase, idClase, nombre) VALUES (003, 01, 'Hermita�o');
INSERT INTO SUBCLASES (idSubclase, idClase, nombre) VALUES (004, 02, 'Artista acad�mico');
...
INSERT INTO SUBCLASES (idSubclase, idClase, nombre) VALUES (021, 07, 'Jurado de inspiraci�n');
...
INSERT INTO SUBCLASES (idSubclase, idClase, nombre) VALUES (024, 08, 'Ladr�n');
INSERT INTO SUBCLASES (idSubclase, idClase, nombre) VALUES (025, 08, 'Brib�n');
...
INSERT INTO RELIGIONES (nombre) VALUES ('Her�tico Insentiente');
INSERT INTO RELIGIONES (nombre) VALUES ('Adorador del Retorno');
INSERT INTO RELIGIONES (nombre) VALUES ('Test�gos del �ltimo Heroe');
...
INSERT INTO O_NACIONES (nombre) VALUES ('Archipi�lago Coralino');
...
INSERT INTO O_REINOS (nombreNacion, nombre) VALUES ((SELECT nombre FROM O_NACIONES WHERE idNacion = '9'), 'T�merax');
INSERT INTO O_REINOS (nombreNacion, nombre) VALUES ((SELECT nombre FROM O_NACIONES WHERE idNacion = '9'), 'Orgona');
INSERT INTO O_REINOS (nombreNacion, nombre) VALUES ((SELECT nombre FROM O_NACIONES WHERE idNacion = '9'), 'C�netra');
INSERT INTO O_REINOS (nombreNacion, nombre) VALUES ((SELECT nombre FROM O_NACIONES WHERE idNacion = '9'), 'Gargatra');
INSERT INTO O_REINOS (nombreNacion, nombre) VALUES ((SELECT nombre FROM O_NACIONES WHERE idNacion = '9'), 'Ap�trax');
INSERT INTO O_REINOS (nombreNacion, nombre) VALUES ((SELECT nombre FROM O_NACIONES WHERE idNacion = '9'), 'Krot�rax');
...
INSERT INTO O_REINOS (nombreNacion, nombre) VALUES ((SELECT nombre FROM O_NACIONES WHERE idNacion = '9'), 'Sufr�xis');
INSERT INTO O_REINOS (nombreNacion, nombre) VALUES ((SELECT nombre FROM O_NACIONES WHERE idNacion = '10'), 'Tierras de la Peste');
INSERT INTO O_REINOS (nombreNacion, nombre) VALUES ((SELECT nombre FROM O_NACIONES WHERE idNacion = '11'), 'Archipi�lago Coralino');
...
INSERT INTO IDEOLOGIAS (idNacion, nombre) VALUES ((SELECT idNacion FROM O_NACIONES WHERE nombre = 'Nordast'), 'Fiel a la nueva monarqu�a');
...
INSERT INTO IDEOLOGIAS (idNacion, nombre) VALUES ((SELECT idNacion FROM O_NACIONES WHERE nombre = 'Dornan'), 'Mo�ug');
...
INSERT INTO IDEOLOGIAS (idNacion, nombre) VALUES ((SELECT idNacion FROM O_NACIONES WHERE nombre = 'Imperio Sirivi'), 'Hijo de la Rep�blica');
...
INSERT INTO OBJETOS (rareza, nombre, valor, peso) VALUES ('Com�n', 'Poci�n', 10, 1);
INSERT INTO OBJETOS (rareza, nombre, valor, peso) VALUES ('Raro', 'Espada Larga', 150, 5);
INSERT INTO OBJETOS (rareza, nombre, valor, peso) VALUES ('�pico', 'Armadura Drag�n', 500, 20);
INSERT INTO OBJETOS (rareza, nombre, valor, peso) VALUES ('Com�n', 'Antorcha', 5, 2);
INSERT INTO OBJETOS (rareza, nombre, valor, peso) VALUES ('Raro', 'Amuleto M�stico', 200, 1);
INSERT INTO OBJETOS (rareza, nombre, valor, peso) VALUES ('�pico', 'Cetro del Vac�o', 750, 3);
INSERT INTO OBJETOS (rareza, nombre, valor, peso) VALUES ('Com�n', 'Botas de Cuero', 25, 1);
